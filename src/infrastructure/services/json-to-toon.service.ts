// src/infrastructure/services/json-to-toon.service.ts

/**
 * Optimized JSON to TOON converter
 * Minimizes output size while preserving design system info
 * Keeps icons but removes regular images
 */
